...
ECHO  10gen
ECHO  script to start a sharded environment on localhost
...
ECHO  start a replica set and tell it that it will be a shord0
...
ECHO  connect to one server and initiate the set
...
ECHO  start a replicate set and tell it that it will be a shard1
...
ECHO  start a replicate set and tell it that it will be a shard2
...
ECHO  now start 3 config servers
...
ECHO  add shards and enable sharding on the test db
